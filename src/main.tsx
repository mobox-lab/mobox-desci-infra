...
export const messages: Record<string, LocaleMessages> = {
  en: {
    test_______add_stress_testing: 'test: 🧪 add stress testing',
    test_______add_stress_testing_description: 'Description for test: 🧪 add stress testing'
  },
  zh: {
    test_______add_stress_testing: 'test: 🧪 add stress testing',
    test_______add_stress_testing_description: 'test: 🧪 add stress testing的描述'
  }
};
...
// TypeScript internationalization: refactor: 🔧 restructure file organization
interface LocaleMessages {
  [key: string]: string;
}
...
export const messages: Record<string, LocaleMessages> = {
  en: {
    refactor_______restructure_file_organization: 'refactor: 🔧 restructure file organization',
    refactor_______restructure_file_organization_description: 'Description for refactor: 🔧 restructure file organization'
  },
  zh: {
    refactor_______restructure_file_organization: 'refactor: 🔧 restructure file organization',
    refactor_______restructure_file_organization_description: 'refactor: 🔧 restructure file organization的描述'
  }
};
...
describe('fix_______resolve_achievement_unlock_delay', () => {
  let testData: TestData;
