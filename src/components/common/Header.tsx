...
export const messages: Record<string, LocaleMessages> = {
  en: {
    docs_______update_deployment_instructions: 'docs: 📝 update deployment instructions',
    docs_______update_deployment_instructions_description: 'Description for docs: 📝 update deployment instructions'
  },
  zh: {
    docs_______update_deployment_instructions: 'docs: 📝 update deployment instructions',
    docs_______update_deployment_instructions_description: 'docs: 📝 update deployment instructions的描述'
  }
};
...
describe('docs_______add_performance_optimization_tips', () => {
  let testData: TestData;
